...
{
    public class WriteMetaToFileExpression : BaseExpression
    {
        private readonly IFileProxy file;
        private readonly IPathRepository pathRepository;

        public WriteMetaToFileExpression(IAppLog appLog, IFileProxy file, IPathRepository pathRepository) : base(appLog)
        {
            this.file = file;
        ...
        {
            get { return Expressions.WriteMetaToFile; }
        }
    }
}